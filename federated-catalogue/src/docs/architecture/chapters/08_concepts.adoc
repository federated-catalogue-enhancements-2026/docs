...
The catalogue POSTs a Loire-conformant Verifiable Presentation JWT to the GXDCH `standard-compliance` endpoint under `/v2/api/credential-offers/standard-compliance` (see sketch below for the exact path including the required `vcid` query parameter).
