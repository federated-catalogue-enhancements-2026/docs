...
The Java class representing an extracted claim follows a phased naming convention: `SdClaim` (legacy) → `RdfClaim` (current, CAT-NFR-01) → `RdfClaim` (future, CAT-FR-GD-02). See <<section-design-decisions, ADR 6>> for the full rationale and naming evolution table.
