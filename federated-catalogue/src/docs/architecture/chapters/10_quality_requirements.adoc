...
Decisions favour replaceability over coupling: pluggable graph backends (ADR 18), self-contained trust-framework bundles (ADR 10), and a wire-shape-agnostic compliance client (ADR 17) all exist to let pieces of the system evolve independently.
