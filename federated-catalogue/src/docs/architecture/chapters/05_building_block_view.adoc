...
Validation results are persisted in the `validation_result` table (introduced by CAT-FR-CO-02, Liquibase changeset `015-validation-result-outdated.xml`).
