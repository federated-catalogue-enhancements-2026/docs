...
This split keeps the bundle (config, roles, ontology) immutable in code/resources, while the runtime enable/disable decision and the runtime overrides of external client identifiers stay as operator state in the database.
