...
classDiagram
    ...
    VerificationServiceImpl --> CredentialFormatDetector : pre-classifies<br/>non-JWT bodies
    ...
    CredentialIngestionStrategy --> EnvelopedCredentialResolver : EVC/EVP unwrap +<br/>inner-VC verify
    ...
    LoireCredentialProcessor --> LoirePolicyEnforcer : enforces did#58;web +<br/>trust chain
    LoireCredentialProcessor --> JwtSignatureVerifier : verifies JWT signature
    Vc2DanubeTechCredentialProcessor --> JwtSignatureVerifier : verifies JWT signature<br/>(JWT bodies only)
    LoirePolicyEnforcer --> TrustFrameworkService : isEnabled("gaia-x")
    LoirePolicyEnforcer --> TrustFrameworkRegistry : reads trust_anchor_url<br/>from bundle properties
...
classDiagram
    ...
    TrustFrameworkService --> TrustFrameworkRepository : reads/writes<br/>enabled flag
    LoirePolicyEnforcer --> TrustFrameworkService : isEnabled("gaia-x")
....
