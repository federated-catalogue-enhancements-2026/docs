...
Self-description, schema, and query endpoint access is controlled by fine-grained permissions:

[options="header",cols="1,2"]
|===
| Permission | Grants access to
| ASSET_CREATE | Create self-descriptions and upload assets
| ASSET_READ | Read and list self-descriptions and assets
| ASSET_UPDATE | Revoke self-descriptions
| ASSET_DELETE | Delete self-descriptions and assets
...
| Ro-SD-A | Self-Description Administrator | ASSET_CREATE, ASSET_READ, ASSET_UPDATE, ASSET_DELETE, SCHEMA_READ
